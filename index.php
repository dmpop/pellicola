...
-->
	...
	*/
	...
	if (isset($upload)) {
	$scriptname = basename($_SERVER["SCRIPT_NAME"]).'?upload&d='.$sub_photo_dir;
...
EOD;
	...
	echo '<div class="footer">'.$footer.' <a href="'.$_SERVER['PHP_SELF'].'?menu&d='.$sub_photo_dir.'"><i class="fa fa-cogs fa-lg"></i></a></div>';
